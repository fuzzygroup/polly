...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference("Availability.count") do
      post availabilities_url, params: { availability: { availability: @availability.availability, date_end: @availability.date_end, date_start: @availability.date_start, user_id: @availability.user_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { availability: @availability.availability, date_end: @availability.date_end, date_start: @availability.date_start, user_id: @availability.user_id } }
