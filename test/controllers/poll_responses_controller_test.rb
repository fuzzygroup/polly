...
class PollResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll_response" do
    assert_difference("PollResponse.count") do
      post poll_responses_url, params: { poll_response: { poll_id: @poll_response.poll_id, value: @poll_response.value } }
    end
  ...
  test "should update poll_response" do
    patch poll_response_url(@poll_response), params: { poll_response: { poll_id: @poll_response.poll_id, value: @poll_response.value } }
