...
class TeamUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_user" do
    assert_difference("TeamUser.count") do
      post team_users_url, params: { team_user: { active: @team_user.active, leader: @team_user.leader, notes: @team_user.notes, team_id: @team_user.team_id, user_id: @team_user.user_id } }
    end
  ...
  test "should update team_user" do
    patch team_user_url(@team_user), params: { team_user: { active: @team_user.active, leader: @team_user.leader, notes: @team_user.notes, team_id: @team_user.team_id, user_id: @team_user.user_id } }
